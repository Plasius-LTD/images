...
describe("svg avatar validation", () => {
  ...
  it("rejects escaped CSS url references in avatar SVGs", async () => {
    const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="10" height="10"><rect width="10" height="10" fill="u\\72l(https://example.com/fill.svg#x)" /></svg>`;
